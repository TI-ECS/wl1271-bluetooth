...
# * \file    BT_Demo.sh
# *
# * \brief   Script to demonstrate the BT features
# *
# * \version 02a,28Jul10, modified 
# * \version 02b,09Dec10, modified
# * \version 02c,15May11, modified
# ***************************************************************************/
...
BT_AVRCP_CTRL=BT_AVRCP_Control.sh
BT_AVRCP_VOL=BT_AVRCP_Volume.sh
BT_PAIR=BT_Pair.sh
...
#       AVRCP Tests
        echo "
        Help:
	    Before running AVRCP Test, ensure that we have the following mandatory inputs
            a. BD Address of Remote BT-Device (Use Option-1 of MAIN MENU)
            b. The A2DP is working (listening to music)
        "

        echo "1. AVRCP Controls..."
        echo "2. AVRCP Volume..."
        echo "3. Goto MAIN MENU"
        echo -n " ====> "
        read OPT
